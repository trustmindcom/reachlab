...
export default function ExtensionSetup({ onNext, onSkip }: ExtensionSetupProps) {
  ...
  return (
    <div className="max-w-lg mx-auto">
      <h2 className="text-[22px] font-semibold text-text-primary mb-2">Connect LinkedIn</h2>
      ...
      <div className="space-y-4 mb-6">
        <div className="flex gap-3 items-start">
          <span className="w-6 h-6 rounded-full bg-accent/10 text-accent text-[15px] font-semibold flex items-center justify-center flex-shrink-0 mt-0.5">1</span>
          <div>
            <p className="text-[15px] text-text-primary">Open Chrome extensions page</p>
            <button onClick={copyUrl} className="text-[14px] text-accent hover:underline mt-0.5">
              {copied ? "Copied!" : "Copy chrome://extensions"}
            </button>
          </div>
        </div>
        <div className="flex gap-3 items-start">
          <span className="w-6 h-6 rounded-full bg-accent/10 text-accent text-[15px] font-semibold flex items-center justify-center flex-shrink-0 mt-0.5">2</span>
          <p className="text-[15px] text-text-primary">Enable &ldquo;Developer mode&rdquo; (toggle in top-right)</p>
        </div>
        <div className="flex gap-3 items-start">
          <span className="w-6 h-6 rounded-full bg-accent/10 text-accent text-[15px] font-semibold flex items-center justify-center flex-shrink-0 mt-0.5">3</span>
          <div>
            <p className="text-[15px] text-text-primary">
              Click &ldquo;Load unpacked&rdquo; and select the{" "}
              <code className="text-[14px] bg-surface-2 px-1.5 py-0.5 rounded">extension/dist</code> folder inside your ReachLab directory
            </p>
      ...
      {!connected ? (
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 text-[15px] text-green-400">
          ...
          <a
            ...
            className="block w-full py-3 bg-accent text-white rounded-xl text-[16px] font-medium text-center hover:opacity-90"
          >
            Open LinkedIn Analytics
          </a>
          <p className="text-[14px] text-text-muted text-center">Waiting for posts to sync...</p>
        </div>
      ) : (
        <div className="space-y-4">
          <div className="flex items-center gap-2 text-[15px] text-green-400">
